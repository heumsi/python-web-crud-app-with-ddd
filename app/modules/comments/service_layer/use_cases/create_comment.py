...
class CreateComment:
    ...
    def execute(self, req: CreateCommentRequest, uow: UnitOfWork) -> CreateCommentResponse:
        with uow:
            comment = Comment(user_id=req.user_id, post_id=req.post_id, content=req.content)
