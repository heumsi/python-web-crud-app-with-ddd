...
from app.modules.comments.service_layer.use_cases.delete_comment import DeleteComment, DeleteCommentRequest
...
def delete_comment(
    ...
    req = DeleteCommentRequest(comment_id=comment_id, requested_user_id=token_payload.user_id)
